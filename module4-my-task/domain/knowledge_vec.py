...
# Модель кешується після першого завантаження (~470 МБ). Далі мережа не потрібна:
# офлайн-режим прибирає похід на HF Hub за метаданими і попередження про HF_TOKEN.
# Перший запуск: HF_HUB_OFFLINE=0 uv run ...
