...
def ask(system: str, user: str, max_tokens: int = 400, fast: bool = True) -> str:
    ...
    його прибрано з messages.create, а на моделях 4.7+ API відхиляє його й на
    рівні запиту. Детермінізм класифікації забезпечується промптом (жорсткий
    формат відповіді), а не семплінгом — temperature=0 ідентичних відповідей
    і раніше не гарантувала.
    """
